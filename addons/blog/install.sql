--
-- 表的结构 `__PREFIX__blog_block`
--

CREATE TABLE `__PREFIX__blog_block` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='博客区块表';

--
-- 转存表中的数据 `__PREFIX__blog_block`
--
BEGIN;
INSERT INTO `__PREFIX__blog_block`(`id`, `type`, `name`, `title`, `image`, `url`, `content`, `weigh`, `createtime`, `updatetime`, `status`) VALUES
(1, '焦点图', 'indexfocus', '首页焦点图标题1', '/assets/addons/blog/default/example/15.jpg', '/', '', 1, 1553606219, 1565316234, 'normal'),
(2, '焦点图', 'indexfocus', '首页焦点图标题2', '/assets/addons/blog/default/example/13.jpg', '/', '', 2, 1553606219, 1565316228, 'normal'),
(3, '焦点图', 'indexfocus', '首页焦点图标题3', '/assets/addons/blog/default/example/12.jpg', '/', '', 3, 1565316188, 1565316197, 'normal'),
(4, '焦点图(小)', 'indexsmallfocus', '首页小焦点图标题1', '/assets/addons/blog/default/example/21.jpg', '/', '', 4, 1565316372, 1565316372, 'normal'),
(5, '焦点图(小)', 'indexsmallfocus', '首页小焦点图标题2', '/assets/addons/blog/default/example/16.jpg', '/', '', 5, 1565316395, 1565316395, 'normal'),
(6, '右侧边栏', 'sidebarad1', '边栏广告1', 'https://cdn.fastadmin.net/assets/addons/ask/img/sidebar/howto.png', '/', '', 6, 1565316474, 1565317115, 'normal'),
(7, '右侧边栏', 'sidebarad2', '边栏广告2', 'https://cdn.fastadmin.net/uploads/store/enterprisehost.png', '/', '', 7, 1565316526, 1565317110, 'normal');
COMMIT;
-- --------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='博客评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='博客日志表';
